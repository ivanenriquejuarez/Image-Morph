...
int main() {
    ...
    int num_frames = 100;  // Total number of frames
    ...
    // Parallel for loop with ordered clause for sequential file writing
    ...
    for (int frame = 0; frame < num_frames; frame++) {
        ...
        // Use ordered to enforce sequential file writing
        #pragma omp ordered
