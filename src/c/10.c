...
// Function to generate an SVG file for the given circle, saving to output_5 folder
...
int main() 
{
    ...
    if (stat("output_5", &st) == -1) {
        mkdir("output_5", 0700);  // Create the directory with rwx permissions for the owner
    }
